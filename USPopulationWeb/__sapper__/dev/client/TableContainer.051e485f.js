import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, c as claim_element, b as children, f as claim_text, g as detach_dev, h as claim_space, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as set_data_dev, o as noop, p as create_component, q as claim_component, r as mount_component, u as transition_in, w as transition_out, x as destroy_component } from './client.8c15924a.js';
...
class PopulationStat extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*cases*/ ctx[0] === undefined && !("cases" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'cases'");
		}

		if (/*deaths*/ ctx[1] === undefined && !("deaths" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'deaths'");
		}

		if (/*recovered*/ ctx[2] === undefined && !("recovered" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'recovered'");
		}

		if (/*hospitalized*/ ctx[3] === undefined && !("hospitalized" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'hospitalized'");
		}

		if (/*ventilator*/ ctx[4] === undefined && !("ventilator" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'ventilator'");
		}

		if (/*icu*/ ctx[5] === undefined && !("icu" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'icu'");
		}

		if (/*tested*/ ctx[6] === undefined && !("tested" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'tested'");
		}

		if (/*updated*/ ctx[7] === undefined && !("updated" in props)) {
			console.warn("<PopulationStat> was created without expected prop 'updated'");
		}
	}
