...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			span0 = claim_element(span3_nodes, "SPAN", { "aria-hidden": true });
		...
		h: function hydrate() {
			if (img.src !== (img_src_value = "logo.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "virus");
			add_location(img, file, 19, 6, 360);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", "navbar-item");
			add_location(a0, file, 18, 4, 321);
			attr_dev(span0, "aria-hidden", "true");
			add_location(span0, file, 27, 6, 559);
			attr_dev(span1, "aria-hidden", "true");
			add_location(span1, file, 28, 6, 593);
			attr_dev(span2, "aria-hidden", "true");
			add_location(span2, file, 29, 6, 627);
			attr_dev(span3, "class", "navbar-burger");
			attr_dev(span3, "aria-label", "menu");
			attr_dev(span3, "aria-expanded", "false");
			toggle_class(span3, "is-active", /*isOpen*/ ctx[1]);
			add_location(span3, file, 21, 4, 408);
			attr_dev(div0, "class", "navbar-brand");
			add_location(div0, file, 17, 2, 290);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", "navbar-item");
			toggle_class(a1, "is-active", /*segment*/ ctx[0] === undefined);
			add_location(a1, file, 34, 6, 766);
			attr_dev(a2, "href", "/about");
			attr_dev(a2, "class", "navbar-item");
			toggle_class(a2, "is-active", /*segment*/ ctx[0] === "about");
			add_location(a2, file, 37, 6, 869);
			attr_dev(div1, "class", "navbar-start");
			add_location(div1, file, 33, 4, 733);
			attr_dev(div2, "class", "navbar-menu");
			toggle_class(div2, "is-active", /*isOpen*/ ctx[1]);
			add_location(div2, file, 32, 2, 678);
			attr_dev(nav, "class", "navbar svelte-1uu19y6");
		...
		m: function mount(target, anchor, remount) {
			...
			append_dev(a2, t6);
			if (remount) dispose();
			dispose = listen_dev(span3, "click", /*toggleNav*/ ctx[2], false, false, false);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ isOpen, segment, toggleNav });
	...
	return [segment, isOpen, toggleNav];
}
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file$1, 19, 8, 310);
			attr_dev(div0, "class", "message-header");
			add_location(div0, file$1, 18, 6, 273);
			attr_dev(div1, "class", "message-body");
			add_location(div1, file$1, 21, 6, 342);
			attr_dev(article, "class", "message is-danger");
			add_location(article, file$1, 17, 4, 231);
			attr_dev(div2, "class", "container svelte-1m9a4uf");
			add_location(div2, file$1, 16, 2, 203);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			p = claim_element(div0_nodes, "P", {});
			var p_nodes = children(p);
			t0 = claim_text(p_nodes, "Page Not Found");
			p_nodes.forEach(detach_dev);
			div0_nodes.forEach(detach_dev);
			t1 = claim_space(article_nodes);
			div1 = claim_element(article_nodes, "DIV", { class: true });
			...
			t2 = claim_text(a_nodes, "Click here");
		...
		h: function hydrate() {
			add_location(p, file$1, 30, 8, 552);
			attr_dev(div0, "class", "message-header");
			add_location(div0, file$1, 29, 6, 515);
			attr_dev(a, "href", "/");
			add_location(a, file$1, 33, 8, 628);
			attr_dev(div1, "class", "message-body");
			add_location(div1, file$1, 32, 6, 593);
			attr_dev(article, "class", "message is-warning");
			add_location(article, file$1, 28, 4, 472);
			attr_dev(div2, "class", "container svelte-1m9a4uf");
			add_location(div2, file$1, 27, 2, 444);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, article);
...
function create_fragment$2(ctx) {
	...
	let if_block0 = /*status*/ ctx[0] !== 404 && create_if_block_1(ctx);
	let if_block1 = /*status*/ ctx[0] === 404 && create_if_block(ctx);
	...
	const block = {
		...
		l: function claim(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-1jqd4yi\"]", document.head);
...
const components = [
	{
		js: () => import('./index.1d5a49be.js'),
		css: ["client.8c15924a.css","TableContainer.051e485f.css"]
	},
	{
		js: () => import('./about.b9a06f6b.js'),
		css: ["client.8c15924a.css"]
	},
	{
		js: () => import('./[state].6914f819.js'),
		css: ["client.8c15924a.css","TableContainer.051e485f.css"]
	}
];
...
const routes = (d => [
...

	{
		...
		pattern: /^\/([^\/]+?)\/?$/,
		parts: [
			{ i: 2, params: match => ({ state: d(match[1]) }) }
		]
	}
])(decodeURIComponent);
